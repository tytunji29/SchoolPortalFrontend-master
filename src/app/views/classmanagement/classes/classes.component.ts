...
export class ClassesComponent { conList: any[] = [];
  searchText: string = '';
  p: number = 1;
  ...
  classLevels: any[] = [];
  classTeachers: any[] = [];
  currentCountry: any = { name: '',classLevel:'',classTeacher:'',classAssistTeacher:'' };
  ...
  saveCountry() {
    ...
    const asstesa =`${this.currentCountry.classAssistTeacher}`
    const payload = {
      name:cnValu,
      teacher:tesa,
      assistantTeacher:asstesa
    };
