...
export class ParentComponent {
  ...
  refreshData(): void {
    this.apiService.get<ApiResponse>('Parent/GetAll').subscribe({
  ...
  onSubmit() {
    ...
    this.apiService.post<ApiResponse>('Parent/Add', formData).subscribe({
      next: (response: any) => {
  ...
  saveCountry() {
    ...
    this.apiService.post<ApiResponse>('Parent/Add', this.currentCountry).subscribe({
      next: (response:any) => {
  ...
  updateCountry() {
    ...
    formData.append('religion', this.currentCountry.religion);
    console.log('Form submission successful', formData);
    this.apiService.put<ApiResponse>(`Parent/UpdateById/${this.currentCountry.id}`, formData).subscribe({
      next: (response: any) => {
        if (response.status === 'success') {
  ...
  deleteCountry(country: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.apiService.delete<ApiResponse>(`Parent/DeleteById/${country.id}`).subscribe({
          next: () => {
