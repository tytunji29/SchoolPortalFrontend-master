...
export class StaffComponent {
  ...
  refreshData(): void {
    this.apiService.get<ApiResponse>('Staff/GetAll').subscribe({
  ...
  onSubmit() {
    ...
    formData.append('staffType', this.currentCountry.staffType);
    console.log('Form submission successful', formData);

    this.apiService.post<ApiResponse>('Staff/Add', formData).subscribe({
      next: (response: any) => {
  ...
  saveCountry() {
    ...
    this.apiService.post<ApiResponse>('Staff/Add', this.currentCountry).subscribe({
      next: (response:any) => {
  ...
  updateCountry() {
    ...
    formData.append('gender', this.currentCountry.gender);
    formData.append('numberOfKidsInTheSchool', this.currentCountry.subscriptionTypeFee);
    formData.append('staffType', this.currentCountry.staffType);
    formData.append('dob', this.currentCountry.dob);
    formData.append('mobileNumber', this.currentCountry.mobileNumber);
    formData.append('tribe', this.currentCountry.tribe);
    formData.append('religion', this.currentCountry.religion);
    console.log('Form submission successful', formData);
    this.apiService.put<ApiResponse>(`Staff/UpdateById/${this.currentCountry.id}`, formData).subscribe({
      next: (response: any) => {
        if (response.status === 'success') {
  ...
  deleteCountry(country: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.apiService.delete<ApiResponse>(`Staff/DeleteById/${country.id}`).subscribe({
          next: () => {
